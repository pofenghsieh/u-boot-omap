...
#define CTRL_CORE_MPU_IRQ_148_REG			0x4A002b60
#define CTRL_CORE_MPU_IRQ_149_REG			0x4A002b62
#define CTRL_CORE_MPU_IRQ_150_REG			0x4A002b64
#define CTRL_CORE_MPU_IRQ_151_REG			0x4A002b66
...
static void set_crossbar_mpu_irq(void)
{
	...
	writew(351, CTRL_CORE_MPU_IRQ_152_REG); /* VIP1_IRQ_1 */
	writew(392, CTRL_CORE_MPU_IRQ_153_REG); /* VIP1_IRQ_2 */
	writew(352, CTRL_CORE_MPU_IRQ_150_REG); /* VIP2_IRQ_1 */
	writew(393, CTRL_CORE_MPU_IRQ_151_REG); /* VIP2_IRQ_2 */
	writew(353, CTRL_CORE_MPU_IRQ_148_REG); /* VIP3_IRQ_1 */
	writew(394, CTRL_CORE_MPU_IRQ_149_REG); /* VIP3_IRQ_2 */
